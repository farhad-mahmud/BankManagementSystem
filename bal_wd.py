...
class Appli(object):
  def __init__(self, master):
     ...
     self.heading= Label(self.top, text="Balance Withdraw", font="helvetica 18 bold", bg="#f4f5f5")
     ...
     self.dep= Button(self.bottom, text=" Withdraw ", font="helvetica 15 bold", width="52", command=dept)
